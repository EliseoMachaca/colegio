...
<!--sweet alert-->
<script type="text/javascript" src="<?=APP_URL;?>/js/sweetalert/sweetalert2.min.js"></script>


<!-- AdminLTE App -->
<script src="<?=APP_URL;?>/dist/js/adminlte.min.js"></script>
<!--Usuarios-->
<script src="js/functions-generales.js"></script>
<script src="js/functions-actividades.js"></script>
<script src="js/functions-entregas.js"></script>
<script src="js/functions-nota.js"></script>
<script src="js/functions-calificaciones.js"></script>
